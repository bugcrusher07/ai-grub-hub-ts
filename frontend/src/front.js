...
export const UserProfile = ({ User }) => {
  ...
  console.log(
    `emails is ${email} date is ${date} username is ${username} isDetails ${isDetails}`
  );
      ...
      >
        {Array(textStrip)
          ...
          .map((_, index) => (
            ...
            >
              AI is a highly innovative technology but it should be used and
              treated as what it really is, a clever tool to amplify human
              potential
            </span>
          ))}
      </div>
...
const ButtonForAI = () => {
  ...
  return (
    <button className="div_button" style={style}>
      Explore
    </button>
  );
};
      ...
      <div className="footer_body">
        <div className="bottom_section_bar">
          ...
          <div>
            ...
            <button id="bottom_section_button2">
              SIGN UP FOR OUR NEWSLETTER
            </button>
          </div>
        </div>
        <div
          className="front_bottom_section"
          style={{ backgroundColor: '#0A142F', height: '350px' }}
        >
        ...
        >
          ...
          >
            ...
            <div style={{ color: 'white' }}>
              <h4>@2025 Lift Media. All Rights Reserved</h4>
            </div>
  ...
  return (
    <div className="front_app">
      ...
      <div className="main_Header_Front">
        <Logo />
        <MidMenuTopBar />
        <button id="front_search" onClick={handleSearchClick}>
          <img src="/search2.png" alt="Search"></img>
        </button>
        ...
        {loading ? (
          ...
          <button id="front_signIn" onClick={handleLogin}>
            SIGN IN
          </button>
        )}
      ...
      <AiToolsContainer
        searchQuery={'e'}
        shouldFilter={false}
        returnQueryResult={dummyReturnQueryResult}
      />
      <BottomSection />
    </div>
  );
